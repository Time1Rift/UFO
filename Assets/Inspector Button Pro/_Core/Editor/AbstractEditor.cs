...
namespace com.cyborgAssets.internalIBPEditor
{
    public abstract class AbstractEditor : UnityEditor.Editor
    {
        ...
        private void OnEnable()
        {
            ...
            {
                var attributes = methodInfo.GetCustomAttributes(typeof(inspectorButtonPro.IButtonAttribute), true);
                if (!attributes.Any())
                    continue;
        ...
        public override void OnInspectorGUI()
        {
            ...
            foreach (var methodParams in methodsParams)
            {
                ...
                var attribute = methodParams
                    .Key
                    .GetCustomAttributes(typeof(inspectorButtonPro.IButtonAttribute), true)[0] as inspectorButtonPro.IButtonAttribute;
